...
var AuthorizationService = /** @class */ (function () {
    ...
    AuthorizationService.prototype.getClientAuthHeader = function () {
        if (this.config.clientId && this.config.clientSecret) {
            var basicAuth = btoa(this.config.clientId + ":" + this.config.clientSecret);
    ...
    AuthorizationService.prototype.authorize = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var connector, req, clientAuth, config, data, res, json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        connector = new RestConnector();
                        req = new Request({ url: this.config.authorizeURL });
                        clientAuth = this.getClientAuthHeader();
                        if (clientAuth) {
