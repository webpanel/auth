...
var AuthorizationService = /** @class */ (function () {
    ...
    AuthorizationService.prototype.authorize = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, grantType, audience, redirectUri, res, uri;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.config, grantType = _a.grantType, audience = _a.audience, redirectUri = _a.redirectUri;
                        global.console.log("authorizing", this.config.grantType, window.location.pathname);
                        if (!(grantType === "authorization_code")) return [3 /*break*/, 3];
                        if (!(window.location.pathname === "/oauth/callback")) return [3 /*break*/, 2];
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, new Promise(function (resolver) { return setTimeout(resolver, 10000); })];
