...
var Auth = /** @class */ (function (_super) {
    ...
    function Auth() {
        ...
        _this.auth = new AuthorizationService({
            ...
            logoutUri: _this.props.logoutUri,
        ...
        _this.authorize = function () { return __awaiter(_this, void 0, void 0, function () {
            var response, err_1, authorizationError_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.setState({ isAuthorizing: true });
                    ...
                    case 4:
                        err_1 = _a.sent();
                        global.console.log("failed authorize", err_1);
                        return [3 /*break*/, 5];
    ...
    Auth.prototype.render = function () {
        var _this = this;
        var isAuthorizing = this.state.isAuthorizing;
        if (isAuthorizing) {
            return "...";
        }
