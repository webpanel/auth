...
var Auth = /** @class */ (function (_super) {
    ...
    function Auth() {
        ...
        _this.auth = new AuthorizationService({
            authorizeURL: _this.props.oauthTokenURL
        });
        _this.state = { isAuthorizing: false, authorizationError: null };
        _this.handleLogin = function (username, password) { return __awaiter(_this, void 0, void 0, function () {
            var token, authorizationError_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.auth.authorize(username, password)];
                    case 2:
                        token = _a.sent();
                    ...
                    case 3:
                        ...
                        this.setState({ authorizationError: authorizationError_1 });
                        return [3 /*break*/, 4];
                    case 4:
