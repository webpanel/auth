...
var AuthError = /** @class */ (function (_super) {
    ...
    function AuthError(message, description) {
    ...
    OAuth2Auth.prototype.render = function () {
        ...
        if (this.authSession.isLogged() && this.authSession.data) {
            ...
            if (authorizationError) {
                return failed ? (failed({ logout: function () { return _this.logout(); }, error: authorizationError })) : (React.createElement(React.Fragment, null,
                    "Failed ",
