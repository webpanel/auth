...
var Auth = /** @class */ (function (_super) {
    ...
    function Auth() {
        ...
        _this.auth = new AuthorizationService({
            authorizationUri: _this.props.oauthAuthorizationUri,
            tokenUri: _this.props.oauthTokenUri,
        ...
        _this.authorize = function () { return __awaiter(_this, void 0, void 0, function () {
            var response, e_1, authorizationError_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        e_1 = _a.sent();
                        global.console.log("failed to fetch code", e_1);
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/, new Promise(function (resolve) { return setTimeout(resolve, 5000); })];
                    case 6:
    ...
    Auth.prototype.componentWillMount = function () {
